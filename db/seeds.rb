...
RestaurantPizza.create(restaurant: sottocasa, pizza: cheese, price: 10)
RestaurantPizza.create(restaurant: sottocasa, pizza: pepperoni, price: 12)
RestaurantPizza.create(restaurant: pizzarte, pizza: cheese, price: 11)
